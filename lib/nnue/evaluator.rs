...
impl Evaluator {
    ...
    pub fn piece_values(&self) -> [i64; Role::MAX as usize + 1] {
        ...
        [
            Params::pawn_values()[phase] / Params::BASE,
            Params::knight_values()[phase] / Params::BASE,
            Params::bishop_values()[phase] / Params::BASE,
            Params::rook_values()[phase] / Params::BASE,
            Params::queen_values()[phase] / Params::BASE,
            0,
        ]
    }
