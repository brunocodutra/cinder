...
params! {
    ...
    pawns_correction_bonus: Scalar<110336>,
    minor_correction_bonus: Scalar<116576>,
    major_correction_bonus: Scalar<119200>,
    pieces_correction_bonus: Scalar<111584>,
    ...
    reverse_futility_margin_is_noisy_pv: Scalar<-4902>,
    ...
    futility_margin_is_check: Scalar<27551>,
    futility_margin_is_killer: Scalar<27863>,
    ...
    see_pruning_is_killer: Scalar<-31273>,
    ...
    late_move_reduction_delta: Scalar<4138>,
    late_move_reduction_root: Scalar<-2384>,
    late_move_reduction_is_pv: Scalar<-2906>,
    late_move_reduction_was_pv: Scalar<-901>,
    late_move_reduction_gives_check: Scalar<-3988>,
    late_move_reduction_is_noisy_pv: Scalar<3242>,
    late_move_reduction_is_killer: Scalar<-4802>,
    ...
    late_move_pruning_is_check: Scalar<3917>,
