...
params! {
    ...
    quiet_continuation_bonus_gamma: Param<8084>,
    quiet_continuation_bonus_delta: Param<554>,
    noisy_continuation_bonus_gamma: Param<8331>,
    noisy_continuation_bonus_delta: Param<1243>,
    ...
    quiet_continuation_penalty_gamma: Param<8015>,
    quiet_continuation_penalty_delta: Param<1080>,
    noisy_continuation_penalty_gamma: Param<8527>,
    noisy_continuation_penalty_delta: Param<603>,
    ...
    futility_pruning_threshold: Param<37192>,
    see_pruning_threshold: Param<239747>,
    ...
    late_move_reduction_continuation: Param<4096>,
    ...
    history_rating: Param<4096>,
    continuation_rating: Param<5235>,
    winning_rating_gamma: Param<6129>,
    winning_rating_delta: Param<58527>,
