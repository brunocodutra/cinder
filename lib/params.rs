...
params! {
    ...
    history_bonus_depth: Variable3<{ [0, 2904, 7425] }>,
    history_bonus_is_quiet: Variable2<{ [0, 1045] }>,
    history_bonus_scalar: Variable1<{ [421] }>,
    continuation_bonus_depth: Variable3<{ [0, 1082, 11831] }>,
    continuation_bonus_is_quiet: Variable2<{ [0, 204] }>,
    continuation_bonus_scalar: Variable1<{ [1560] }>,
    history_penalty_depth: Variable3<{ [0, -2168, -10434] }>,
    history_penalty_is_quiet: Variable2<{ [0, -1291] }>,
    history_penalty_scalar: Variable1<{ [-2569] }>,
    continuation_penalty_depth: Variable3<{ [0, -670, -10150] }>,
    continuation_penalty_is_quiet: Variable2<{ [0, 515] }>,
    continuation_penalty_scalar: Variable1<{ [-1999] }>,
