...
params! {
    ...
    history_bonus_depth: Variable2<{ [0, 10329] }>,
    history_bonus_scalar: Variable1<{ [1466] }>,
    continuation_bonus_depth: Variable2<{ [0, 12913] }>,
    continuation_bonus_scalar: Variable1<{ [1764] }>,
    history_penalty_depth: Variable2<{ [0, -12602] }>,
    history_penalty_scalar: Variable1<{ [-3860] }>,
    continuation_penalty_depth: Variable2<{ [0, -10820] }>,
    continuation_penalty_scalar: Variable1<{ [-1484] }>,
