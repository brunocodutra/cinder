...
params! {
    ...
    counter_correction: [12.0],
    pawns_correction_bonus: [0.00059015466, -0.25, 0.25],
    minor_correction_bonus: [0.00057724636, -0.25, 0.25],
    major_correction_bonus: [0.0006286239, -0.25, 0.25],
    pieces_correction_bonus: [0.0006316802, -0.25, 0.25],
    counter_correction_bonus: [0.0006, -0.25, 0.25],
    history_bonus: [0.04, 0.0028119748, 0.25],
    history_penalty: [-0.045, -0.006025375, -0.25],
    continuation_bonus: [0.052, 0.0034933158, 0.25],
    continuation_penalty: [-0.042, -0.00282255, -0.25],
    ...
    nmr_depth: [0.26338834],
    nmr_score: [0.13003238, 0.11947278, 3.219951],
