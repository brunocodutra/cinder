...
params! {
    ...
    probcut_margin_depth: [3.0, 15.0],
    probcut_margin_scalar: [180.0],
    probcut_margin_improving: [-10.0],
    probcut_depth: [0.0, -3.0],
    probcut_depth_bounds: [6.0, 3.0],
    singular_margin_depth: [0.0, 0.4],
    singular_margin_scalar: [0.4],
    singular_depth: [0.5, -0.5],
    singular_depth_bounds: [6.0, 3.0],
    singular_extension_is_quiet: [0.0, 0.5, 0.5, 0.0],
    singular_extension_should_cut: [1.5, -2.0, 0.0],
    singular_extension_is_cut: [1.5, 0.0],
    singular_extension_scalar: [1.0],
    singular_extension_limit: [0.3, 6.0],
    singular_reduction_should_cut: [-2.0, 2.0, 0.0],
    singular_reduction_is_cut: [-2.0, 0.0],
    singular_reduction_scalar: [0.0],
    ...
    lmr_is_root: [-0.25634402, -0.44826812, -0.8956343],
    ...
    lmr_is_noisy_node: [0.35211658, 0.004617254, 0.008945197, -0.003098197],
