...
pub trait MulAdd4x8: SimdInt<Scalar = i8> {
    ...
    fn mul_add_4x8(self, x: Self, y: Self::Output) -> Self::Output;
}
...
mod tests {
    ...
    fn for_i8x8(
        ...
        #[strategy(UniformArrayStrategy::new(-128i32..=127i32).prop_map(i32x2::from_array))]
        y: i32x2,
    ) {
        assert_eq!(w.mul_add_4x8(x, y), w.mul_4x8(x) + y);
    }
    ...
    #[proptest]
    fn for_i8x4(
        #[strategy(UniformArrayStrategy::new(-128i8..=127i8).prop_map(i8x4::from_array))] w: i8x4,
        #[strategy(UniformArrayStrategy::new(0i8..=127i8).prop_map(i8x4::from_array))] x: i8x4,
        #[strategy(UniformArrayStrategy::new(-128i32..=127i32).prop_map(i32x1::from_array))]
        y: i32x1,
    ) {
        assert_eq!(w.mul_add_4x8(x, y), w.mul_4x8(x) + y);
    }
